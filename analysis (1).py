...
def prepare_model_data(df):
    ...
    return model, le, report, X_test, y_test

def export_model_to_onnx(model, output_path="models/fraud_model.onnx"):
    """
    Converts the trained sklearn RandomForest to ONNX format.
    Must be called after prepare_model_data().
    6 features: step, type_encoded, amount, oldbalanceOrg, newbalanceOrig, balance_error
    """
